<template>
    <div class="notifications">
        ...
        <ul class="notifications__listing">
            <li @click="resolveNotificationLink(index)" v-for="(notification, index) in notifications" :key="notification.id" class="notifications__listing__item" :class="[notification.read === 0 ? 'unread' : '']">
...
export default {
    ...
    methods: {
        ...
        markNotificationsAsRead() {
            ...
            this.$store.dispatch('dashboard/readNotifications', this.getReadNotificationIds)
                .then(resp=> {
                    //
                }).catch(e => {
