      ...
      <div class="modal__container">
        ...
        <div class="modal__body">
            <div class="hour-choice">
                <button type="" @click="decreaseHours">
                    -
                </button>
                <p v-if="model.hours === 1">1 hour</p>
                <p v-else> {{model.hours}} hours</p>
                <button type="" @click="increaseHours">
                    +
                </button>
            </div>
            <div class="hours">
                <p><span>From {{startTime}} to  {{model.to_time}}</span> </p>
            </div>
...
export default {
  props: ["title", "width", "close", "header", "classes", "inputs", "startTime", "day", "space", "plan"],
  data() {
      return {
          show: true,
        times: [
