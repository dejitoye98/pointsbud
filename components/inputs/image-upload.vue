<template>
    <div class="container">
        <div class="image">
            ...
            <img :id="'image-display-' +image_index + '-' + product_index" v-if="local_link" :src="local_link" alt="">
            <img :id="'grayscale-'+image_index + '-' + product_index" class="grayscale" v-else src="../../static/image-upload.svg"/>
            <label for="" v-if="!local_link"> Upload image</label>
...
export default {
    ...
    methods: {
        addImage(e) {
            let input = e.target;
            let image_display_loading = document.querySelector('#grayscale-' + this.image_index + '-' + this.product_index);
            let image_display = document.querySelector('#image-display-' +  this.image_index + '-' + this.product_index);
            ...
            try {
                ...
                xhr.onreadystatechange = function(e) {
                    ...
                    vm.$emit('onImageUploaded', {image: response.secure_url, product_index: vm.product_index, image_index: vm.image_index});
