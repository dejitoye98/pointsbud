<template>
        <div>
            <CreatedCampaignModal :show="show_success_modal" @close="closeSuccessModal"/>
            ...
            <div class="traffic">
                ...
                <div class="steps">
                            ...
                            <div class="form">
                                <div class="form__container">
                                    <div class="form-input">
                                        ...
                                        <div class="flex-row">
                                            <label class="radio-label">
                                                <input v-model="campaign.who_can_join"  value="0" name="who_can_join" type="radio">
                                            ...
                                            <label class="radio-label">
                                                <input  v-model="campaign.who_can_join" value="1" name="who_can_join" type="radio">
                                                <div class="radio-indicator"></div>
                                                <div class="radio-text">Only invited marketers</div>
                                            </label>
                                            <label class="radio-label">
                                                <input  v-model="campaign.who_can_join" value="2" name="who_can_join" type="radio">
                                                <div class="radio-indicator"></div>
                                    ...
                                    <div class="form-input">
                                        ...
                                        <div class="flex-row">
                                            <label class="radio-label">
                                                <input v-model="campaign.recurring_links"  value="0" name="intent" type="radio">                                                
                                                <div class="radio-indicator"></div>
                                                <div class="radio-text">Yes</div>
                                            </label>
                                            <label class="radio-label">
                                                <input  v-model="campaign.recurring_links" value="1" name="intent" type="radio">
                                                <div class="radio-indicator"></div>
                    ...
                    <div class="create-container">
                        <button :disabled="loading" @click="createCampaign">Create Campaign</button>
                    </div>
                </div>
            </div>
