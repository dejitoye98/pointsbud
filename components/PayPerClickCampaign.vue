<template>
  <div>
    ...
    <div class="center">
      <p>Create a Per-Per-Click Campaign</p>
    </div>
    <div class="traffic">
      <div class="steps">
            ...
            <div class="form">
              <div class="form__container">
                <div
                  ...
                  v-for="(link,index) in campaign.links_to_advertise"
                  :key="index"
                >
                  ...
                  <div class="form-group form-group--row advert-link-row">
                    <div class="form-input">
                      ...
                      <input
                        type="text"
                        placeholder="https://link-you-want-to-advertise.com"
                        v-model="link.link"
                      />
                    </div>
            ...
            <div class="form">
              <div class="form__container">
                ...
                <div class="application_questions" v-if="[2, '2'].includes(campaign.who_can_join)">
                  <div
                    v-for="(q, index) in campaign.application_questions"
                    :key="index"
                    class="form-input"
                  >
                ...
                <div class="form-input">
                  ...
                  <div class="flex-row">
                    <label class="radio-label">
                      <input
                        v-model="campaign.recurring_links"
                        value="0"
                        name="intent"
                        type="radio"
                      />
              ...
              <div class="form">
                <div class="form__container">
                  <SelectCountriesInput
                    @onCountriesSelected="setCountriesAllowed"
                    important="true"
                    label="What countries should you allow traffic from?"
                  />
                </div>
              </div>
            </div>
