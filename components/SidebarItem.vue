<template>
  <div
    class="side__item"
    :class="[collapsed && collapsed === true ? 'collapsed_side_item' : '']"
    @click="setActive"
  >
    <nuxt-link class="link" :to="'/dashboard' + link">
      ...
      <div class="side__item__icon" v-if="text === 'Wallet'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Campaigns' || text==='Find Campaigns'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Settings'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Overview'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Reservations'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Products'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Bio Links'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div class="side__item__icon" v-if="text === 'Bookings'">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div
        class="side__item__text"
        :class="[active === text ? 'active': '']"
        v-if="!collapsed || collapse === false"
      >
        <p>{{text}}</p>
        <template v-if="updateItems">
          <div
            class="side__item__text__notif"
            v-if="text==='Reservations' && updateItems.reservations"
          >{{updateItems.reservations}}</div>
          <div
            class="side__item__text__notif"
            v-else-if="text==='Reservations' && updateItems.sales"
          >{{updateItems.sales}}</div>
          <div
            class="side__item__text__notif"
