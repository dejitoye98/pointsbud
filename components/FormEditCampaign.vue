    ...
    <div class="campaign__form">
        ...
        <template v-if="step === 1">
            ...
            <div class="form-input">
                ...
                <label class="bold-label" for="">Title of campaign <span>*</span></label>
                <input  v-model="campaign.title" type="text">
            </div>
            <div class="form-input">
                <span class="error">{{errors.description}}</span>
                <label class="bold-label"  for="">Description <span>*</span></label>
                <textarea v-model="campaign.description"> </textarea>
            </div>
            <div class="half">
                <div class="form-input">
                    <span class="error">{{errors.budget}}</span>
                    <label class="bold-label"  for="">Budget <span>*</span></label>
                    <input  v-model="campaign.budget" type="number">
                </div>
                <div class="form-input">
                    <span class="error">{{errors.end_date}}</span>
                    <label class="bold-label"  for="">End Date <span>*</span></label>
                    <DatePicker v-model="campaign.end_date" />
                </div>
            </div>
            <div class="form-input">
                <label class="bold-label"  for="">Display Picture</label>
