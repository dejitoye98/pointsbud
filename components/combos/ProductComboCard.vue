<template>
  ...
  export default {
    ...
    data() {
      return {
        combos: [
          { "combo_name": "Coastal Indulgence", "items": [16, 58, 177] },
          { "combo_name": "Classic English Brunch", "items": [4, 6, 99] },
          { "combo_name": "Africana Delight", "items": [2, 3, 101] },
          { "combo_name": "Surf & Salad", "items": [24, 25, 174] },
          { "combo_name": "Steakhouse Special", "items": [60, 29, 72] },
          { "combo_name": "Spicy Comfort", "items": [18, 27, 84] },
          { "combo_name": "Cheesy Cravings", "items": [13, 50, 99] },
          { "combo_name": "Oven Morning", "items": [5, 6, 101] }
        ],
