<template>
    <div class="table">
        <div class="table">
            <div class="table__options" v-if="show_search || typeof (show_search) === 'undefined'">
                <div class="table__options__search" v-if="show_search || typeof (show_search) === 'undefined'">
                    <SearchInput></SearchInput>
                </div>
                <div class="table__options__filter" v-if="show_filter || typeof (show_filter) === 'undefined'">
                    <svg width="15" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M10.93 2.09998L6 9.99998" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
