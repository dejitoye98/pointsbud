  ...
  <div>
    ...
    <div class="page">
      ...
      <div class="page__content">
        ...
        <div class="page__content__item">
          <p>Cost Per Click</p>
          <p>{{details.pay_currency + 'NGN ' + formatMoney(details.pay_per_click)}}</p>
        </div>
        <div class="page__content__item">
          <p>Cost Per Lead</p>
          <p>{{details.pay_currency + 'NGN' + formatMoney(details.pay_per_lead)}}</p>
        </div>

        <div class="page__content__item">
          <p>Cost Per Sale</p>
          <p>{{details.pay_currency || "NGN" + ' ' + formatMoney(details.pay_per_sale)}}</p>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getLinkDetails() {
      this.$api
        .get(`/links/${this.$route.params.id}/redir_links`)
        .then(resp => {
