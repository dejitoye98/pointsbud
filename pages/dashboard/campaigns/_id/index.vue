<template>
  <div>
    ...
    <template>
      <template
        v-if="userContext === 'marketer' && (!loading.campaign && campaign && campaign.campaign_marketers.length > 0)"
      >
      ...
      <div class="campaign">
        ...
        <template
          v-if="(userContext === 'marketer' && userIsCampaignMarketer) || (userContext === 'business')"
        >
          <template>
