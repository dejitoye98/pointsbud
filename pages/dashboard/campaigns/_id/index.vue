                    ...
                    <template v-if="!loading.campaign">
                        <div class="page__header">
                            <div class="page__header__content">
                                ...
                                <div
                                    class="page__header__status"
                                    v-if="userContext === 'business'"
                                >
                                    <div
                                    ...
                                    ></div>
                                    <div
                                        class="page__header__status__indicator red-fill"
                                        v-else
                                    ></div>

                                    <p class="green" v-if="campaign.is_active">
                                        Active
                                    </p>
                            ...
                            <div
                                class="page__header__ctas"
                                v-if="userContext === 'business'"
                            >
                                <SwitchComponent
                                    v-on:execute="changeCampaignStatus"
                        ...
                        <div class="page__content">
                            ...
                            <div class="page__content__item">
                                <p>Public URL</p>
                                <a class="link" :href="computedUrl"
                                    >https://afflee.com/{{ campaign.slug }}</a
                                >
                            </div>
                        ...
                        <div class="campaign__overview">
                            ...
                            <template v-if="userContext === 'business'">
                                <CampaignBudgetLeftChart
                                    :show="show_campaign_budget_chart"
                                    :campaign="campaign"
                                />
...
export default {
        ...
        getCampaignMarketers() {
            ...
            this.$api
                ...
                .then((resp) => {
                    ...
                    this.campaign_marketers.page_info =
                        resp.data.data.page_info;
                })
                .catch((err) => {
                    this.loading.marketers = false;
                });
    ...
    computed: {
        ...
        campaignBudgetLeftInPercentage() {
            ...
            if (budget_left) {
                const percentage =
                    parseFloat(budget_left / budget).toFixed(2) * 100;
                return percentage;
            } else return 100;
        },
        campaignEndDate() {
