                ...
                <div class="container">
                    <div class="find__body">
                        ...
                        <div class="content">
                            <div class="content__container">
                                <template v-if="!loading">
                                    <div class="content__item" v-for="(marketer, index) in marketers" :key="index" @click="openProfile(marketer)">
                        ...
                        <div class="profile-view">
                            <ProfileView v-if="selected_user_id" user_type="marketer" :user_id="selected_user_id" @onAction="inviteMarketer"/>
                        </div>
                    </div>
...
export default {
    layout: 'dashboard-collapsed-sidebar-with-topbar',
    ...
    methods: {
        ...
        inviteMarketer(marketer_id) {
            ...
            this.$api.post(`/campaigns/${this.campaign_id}/invite`, payload)
                .then(resp=> {
                    this.marketers = this.marketers.filter(m=> m.id !==marketer_id)
