...
export default {
    ...
    methods: {
        addConversionMedia(medium) {
            const index = this.campaign.conversion_media.find(
                (a) => a === medium
            );
            if (index) {
            ...
            if (this.mode === "click") {
                ...
                if (this.step < 4) {
                    if (this.step === 1) {
                        ...
                        this.campaign.links_to_advertise.forEach(
                            (link, index) => {
                                if (
                                    !link.link ||
                                    !link.pay_per_click ||
        ...
        setCostPerClick(meta) {
            this.campaign.links_to_advertise[meta.index].pay_per_click =
                meta.value;
        },
            ...
            if (this.can_continue) {
                ...
                this.$api
                    ...
                    .then((resp) => {
                        this.loading = false;
                        this.$store.dispatch(
                            "dashboard/actionShowSuccessToast",
