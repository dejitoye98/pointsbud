        ...
        <div class="section" v-if="context === 'business'">
                        ...
                        <div class="l-card__body">
                            ...
                            <div class="l-card__content">
                                ...
                                <div class="l-card__content__item">
                                    ...
                                    <p v-if="disbursements.today.amount">NGN {{formatMoney(disbursements.today.amount) || 0}}</p>
                                    <p v-else> NGN 0</p>                                
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="l-card">
                        <div class="l-card__body">
                            ...
                            <div class="l-card__content">
                                ...
                                <div class="l-card__content__item">
                                    <label for="">Value</label>
                                    <p v-if="clicks && clicks.today && clicks.today.amount">NGN {{ formatMoney(clicks && sales.today && clicks.today.amount) }}</p>
                                    <p v-else> NGN 0</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="l-card">
                        <div class="l-card__body">
                            ...
                            <div class="l-card__content">
                                ...
                                <div class="l-card__content__item">
                                    <label for="">Value</label>
                                    <p v-if="sales && sales.today && sales.today.amount">NGN {{ formatMoney(sales && sales.today && sales.today.amount) }}</p>
                                    <p v-else> NGN 0</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="l-card">
                        <div class="l-card__body">
                            ...
                            <div class="l-card__content">
                                ...
                                <div class="l-card__content__item">
                                    <label for="">Value</label>
                                    <p v-if="leads && leads.today && leads.today.amount">NGN {{ formatMoney(leads && leads.today && leads.today.amount) }}</p>
                                    <p v-else>NGN 0</p>                              
                                </div>
                            </div>
                        </div>
            ...
            <div class="section__container">
                ...
                <div class="section__body__stat section__body__stat--earnings" >
                       <StatisticsChart  @onFilterChanged="changeStatisticsFilter" name="disbursements" v-if="disbursements.chart.datasets[0].data.length>0" :filter="disbursements.filter" :chart_data='disbursements.chart'  type="line" title="Disbursements"/>
                   </div>
                   <div class="section__body__stat section__body__stat--earnings">
                        <ValueChart :model="sales" name="Sales Value" :loading="loading.sales" title="Sales Value"/>
                   </div>
                   <div class="section__body__stat section__body__stat--earnings">
                      <!-- <StatisticsChart  @onFilterChanged="changeStatisticsFilter" name="sales"  v-if="sales.chart.datasets[0].data.length>0" :filter="sales.filter" :chart_data='sales.chart'  type="line" title="Sales"/>-->
                          <ValueChart :model="clicks" name="Clicks Value" :loading="loading.clicks" title="Clicks Value"/>
                   </div>
