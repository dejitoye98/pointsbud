<template>
    <div class="outer">
      ...
      <template v-if="table_identifier">

        <VerifyInstoreStatusPage  @onChoose="changeMode"></VerifyInstoreStatusPage>
      </template>
      <template v-else>

        <ChooseModePage  @onChoose="changeMode"></ChooseModePage>
      </template>
      <div class="page" id="page">
          ...
          <ChooseModeModal v-if="choose_mode && !table_identifier && false" @close="choose_mode = false" @onChoose="changeMode"></ChooseModeModal>
