...
export const actions = {
    getBanks({ dispatch, commit }, payload) {
        return new Promise((resolve, reject) => {
            this.$axios.get(`http://api.flutterwave.com/v3/banks/Nigeria`, {
                headers: {
                    Authorization: `Bearer FLWSECK-fd58811bc7e5055038f2a029f374dec3-X`
                }
            })
                .then(resp => {
                    commit('setBanks', resp.data.data)
                    resolve(resp)
                })
                .catch(err => {
